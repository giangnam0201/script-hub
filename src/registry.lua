...
return {
    ...
    ----------------------------------------------------------------------
    -- The finder replaces the old static catalog. It searches scriptblox for
    -- whatever game you are in when you join, so there is no list to keep up
    -- to date and no game left out.
    ----------------------------------------------------------------------
    {
        Name        = "Script Finder",
        Module      = "src/scripts/finder",
        Universal   = true,
        Icon        = "search",
        Author      = "hub",
        Credit      = "scripts by their own authors, via scriptblox",
        Description = "Finds and runs a script for whatever game you are in.",
    },
